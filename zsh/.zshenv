...
path=($HOME/Scripts $HOME/.gem/ruby/2.4.0/bin $HOME/.local/bin /bin /sbin /usr/bin /usr/sbin /usr/local/bin /usr/local/sbin /opt/android-sdk/platform-tools /opt/android-sdk/tools /usr/lib/jvm/default/bin /usr/bin/site_perl /usr/bin/vendor_perl /usr/bin/core_perl $HOME/.node_modules/bin /opt/android-sdk/platform-tools $GOPATH/bin $path[@])
